...
/* copy initPortfolio to appfolio */

function initAppfolio () {
    var appfolio = $('#appfolio');
    var items = $('.items', appfolio); 
    var filters = $('.filters li a', appfolio); 
...
function initTwitterFeed() {
    ...
    twitterFetcher.fetch('578974534075854848', '', 5, true, false, false, '', true, handleTweets, false);
}
